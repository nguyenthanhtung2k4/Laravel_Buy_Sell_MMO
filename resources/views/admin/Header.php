...
<head>
    ...
    <!-- Bootstrap Css -->
    <link id="style" href="<?=BASE_URL('public/tailieu/');?>theme/assets/libs/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link rel="stylesheet" href="<?=BASE_URL('public/tailieu/');?>theme/assets/libs/@simonwep/pickr/themes/nano.min.css">

    <!-- Prism CSS -->
    <link rel="stylesheet" href="<?=BASE_URL('public/tailieu/');?>theme/assets/libs/prismjs/themes/prism-coy.min.css">

    <!-- Choices Css -->
    <link rel="stylesheet" href="<?=BASE_URL('public/tailieu/');?>theme/assets/libs/choices.js/public/assets/styles/choices.min.css">

    <link rel="stylesheet" href="<?=BASE_URL('public/tailieu/');?>theme/assets/libs/glightbox/css/glightbox.min.css">
    ...
    <!-- Sweetalerts CSS -->
    <link rel="stylesheet" href="<?=BASE_URL('public/tailieu/');?>theme/assets/libs/sweetalert2/sweetalert2.min.css">
    <!-- Sweetalerts JS -->
...
<style>
    ...
    ::-webkit-scrollbar {
    width: 15px; /* Độ rộng của thanh cuộn */
    
    }

    ::-webkit-scrollbar-thumb {
    background-color: #c3c3c3; /* Màu nền của thanh cuộn */
    }
...
.table-responsive::-webkit-scrollbar {
    width: 10px; /* Chiều rộng của thanh trượt */
}
...
.table-responsive::-webkit-scrollbar-thumb {
    background: #888; /* Màu của phần cần kéo */
    border-radius: 20px; /* Độ cong của phần cần kéo */
}
/* Handle on hover */
.table-responsive::-webkit-scrollbar-thumb:hover {
    background: #555; /* Màu của phần cần kéo khi di chuột qua */
}
