                        ...
                        <div class="card-body">
                            <div class="row mb-3 gy-2">
                                <div class="col-sm-12 mb-2">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nhập tên mã nguồn" name="name" value="<?=$row['name']?>">
                                </div>
                            <div class="col-md-6">
                                    <div class="mb-4">
                            ...
                            <div class="col-sm-12 mb-2">
                                    <label class="form-label" for="example-hf-email">Link Ảnh Mô Tả: <span class="text-danger">*</span></label></label>
                            ...
                            <div class="col-sm-12 mb-2">
                                    ...
                                    <textarea class="intro" id="intro"
                                        name="intro"><?=$row['intro']?></textarea>
                                </div>
                            <div class="col-sm-12 mb-2">
                                    <label class="form-label" for="example-hf-email">Link Tải Code: <span class="text-danger">*</span></label>
                                <input type="text" class="form-control"
                                    name="link_down" value="<?=buiducthanh_dec($row['link_down'])?>" placeholder="Nhập link tải code" required>
                            </div>
                            <div class="col-sm-12 mb-2">
                                    <label class="form-label" for="example-hf-email">Nội Dung Mô Tả: <span class="text-danger">*</span></label>
