    ...
    <div class="w-breadcrumb-area">
        <div class="breadcrumb-img">
            <div class="breadcrumb-left">
                <img src="/assets/images/banner-bg-03.png" alt="404 Background">
            </div>
        </div>
        <div class="container">
            <div class="row">
    ...
    <section class="contact-section">
        <div class="contact-bottom bg-white text-center py-5">
            <div class="container">
                ...
                <p class="lead fw-bold">Xin lỗi, trang bạn đang tìm không tồn tại hoặc đã bị xóa.</p>
