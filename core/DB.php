...
class DB
{
    ...
    function connect()
    {
        ...
        {
            if (!$this->ketnoi) {
                $this->ketnoi = mysqli_connect('localhost', 'root', 'tung2004', 'license_db') or die('BẢO TRÌ HỆ THỐNG');
                // $this->ketnoi = mysqli_connect(DB_HOST, DB_USER, DB_PASS, DB_NAME) or die('BẢO TRÌ HỆ THỐNG');
