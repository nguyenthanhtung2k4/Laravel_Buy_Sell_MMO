...
// Dòng 7 trong check.php
require_once(__DIR__.'/../db_api_check.php'); // Giữ nguyên, giả định $pdo đã được khởi tạo trước đó
require_once __DIR__.'/helpers.php'; // Sửa lỗi đường dẫn
...
function create_one_time_link($pdo, $license_id, $device_id, $target_url)
{
    ...
    $redirect_url = $protocol . '://' . $_SERVER['HTTP_HOST'] . dirname($_SERVER['REQUEST_URI']) . '/redirect-key?token=' . $token_bytes;
